# Contributing to mss-boot

## Issues

Use the issue templates and include repository version, environment,
...
- Update README, docs, changelog, or `mss-boot-docs/aigc/` when behavior,
  configuration, release policy, or AI workflow changes.
