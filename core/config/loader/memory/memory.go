...
import (
	...
	"github.com/mss-boot-io/mss-boot/core/config/reader/json"
...
// Snapshot returns a snapshot of the current loaded cfg
...
// Sync loads all the sources, calls the parser and updates the cfg
